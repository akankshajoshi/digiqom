# Django settings for digiqom project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'digiqom',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = ')^i+4c@i3#cs$=l-3lq1qh#fg^lhsc%!u!!o&#1_)s0m=xtrk)'
